...
public class YugabyteDBModule extends AbstractModule
{
	...
	public YugabyteDBModule(KairosRootConfig props)
	{
	...
	{
		bind(Datastore.class).to(YugabyteDatastore.class).in(Scopes.SINGLETON);
		bind(ServiceKeyStore.class).to(YugabyteDatastore.class).in(Scopes.SINGLETON);
		bind(YugabyteDatastore.class).in(Scopes.SINGLETON);
		...
		install(new FactoryModuleBuilder().build(YugabyteDBModule.BatchHandlerFactory.class));

		install(new FactoryModuleBuilder().build(YugabyteDBModule.DeleteBatchHandlerFactory.class));

		install(new FactoryModuleBuilder().build(YugabyteDBModule.CQLBatchFactory.class));

		install(new FactoryModuleBuilder().build(YCQLFilteredRowKeyIteratorFactory.class));
	}
